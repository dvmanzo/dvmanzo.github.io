    ...
    e.AmXYChart = e.Class({
        ...
        drawChart: function() {
            ...
            if (0 < this.realWidth && 0 < this.realHeight) {
                e.ifArray(a) ? (this.chartScrollbar &&
                    this.updateScrollbars(), this.zoomChart()) : this.cleanChart();
        ...
        formatString: function(a, b, c) {
            ...
            return a = e.AmXYChart.base.formatString.call(this,
                a, b, c)
        },
        ...
        updateTrendLines: function() {
            ...
            for (b = 0; b < a.length; b++) {
                ...
                d = c.valueAxisX;
                e.isString(d) &&
                    (c.valueAxisX = this.getValueAxisById(d));
        ...
        updateChartCursor: function() {
            ...
            if (a) {
                ...
                a.categoryLineAxis || (a.categoryLineAxis =
                    this.xAxes[0]);
                ...
                a.zoomable && (this.hideYScrollbar || (a.vZoomEnabled = !0),
                    this.hideXScrollbar || (a.hZoomEnabled = !0))
            }
        },
